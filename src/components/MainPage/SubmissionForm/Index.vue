...
<template>
  <v-dialog v-model="indexSubmissionForm"
    :max-width="collapseOrExpandWidth"
    lazy>
    ...
    <v-btn @click="hide = true"
      v-if="!hide"
      color="danger"
      :style="hideButtonStyle"
      :fab="goMobile"
      :small="goMobile">
      <v-icon :left="!goMobile">icon-eye-off</v-icon>
      <span v-if="!goMobile">hide</span>
    </v-btn>
    <v-btn @click="hide = false"
      v-else
      :style="hideButtonStyle"
      :fab="goMobile"
      :small="goMobile">
      <v-icon :left="!goMobile">icon-eye</v-icon>
      <span v-if="!goMobile">show</span>
    </v-btn>
  </v-dialog>
</template>
